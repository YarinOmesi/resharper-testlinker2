...
/**
 * #### Generated from [TestLinkerModel.kt:8]
 */
class TestLinkerModel private constructor(
    ...
    companion object : ISerializersOwner {
        ...
        const val serializationHash = -9005707376077139400L
        
    }
    override val serializersOwner: ISerializersOwner get() = TestLinkerModel
    override val serializationHash: Long get() = TestLinkerModel.serializationHash
    ...
    override fun print(printer: PrettyPrinter)  {
        printer.println("TestLinkerModel (")
        printer.indent {
    ...
    //deepClone
    override fun deepClone(): TestLinkerModel   {
        return TestLinkerModel(
...
val Solution.testLinkerModel get() = getOrCreateExtension("testLinkerModel", ::TestLinkerModel)



/**
 * #### Generated from [TestLinkerModel.kt:10]
 */
enum class MyEnum {
    FirstValue, 
    SecondValue;
...
/**
 * #### Generated from [TestLinkerModel.kt:15]
 */
